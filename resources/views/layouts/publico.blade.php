...
<body>
    <div class="left-menu">
        <div class="content-logo">
            <div class="logo">
                <a href="https://smartports.app/"><img alt="" title="Smartports API" src="images/Smartports-Logo-2022-blue.png" height="50" /></a>
            </div>
        ...
        <div class="content-menu">
            <div class="content-infos">
                ...
                <div class="info"><b>Last Update:</b> {{ $last_update }}</div>
                <div class="info"><b>Last Check:</b> {{ $last_check }}</div>
            </div>
            <ul>
                <li class="scroll-to-link" data-target="postman">
                    <a>POSTMAN</a>
                </li>
